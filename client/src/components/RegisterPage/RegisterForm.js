      ...
      >
        ...
        <Formik
          ...
          validationSchema={Yup.object({
            ...
            password: Yup.string()
              ...
              .matches(
                /^(?=.*[a-z])(?=.*[A-Z])[a-zA-Z\d\W]{16,}$/,
                "รหัสผ่านต้องมีตัวอักษรภาษาอังกฤกตัวเล็กและตัวใหญ่รวมอยู่ด้วย"
              ),
            acceptedTerms: Yup.boolean().oneOf(
              [true],
              "กรุณาอ่านรายละเอียด และยอมรับข้อตกลง"
            ),
          })}
          onSubmit={(values) => {
            register(values);
        ...
        >
          <Form>
            ...
            <MyCheckbox id="checkbox" name="acceptedTerms">
              <Flex mt={"8px"} ml={"16px"} alignItems={"center"} gap={"3px"}>
                {`ยอมรับ `}
            ...
            <Button type="submit" w="440px" h="44px" mt="30px" mb="25px">
              ลงทะเบียน
            </Button>
          </Form>
        </Formik>
