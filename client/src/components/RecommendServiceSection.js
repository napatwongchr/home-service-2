        ...
        <Container className='recommendService' maxW='100%' bg='gray.100' centerContent>
                ...
                <Center w='1440px'>
                    <Grid templateColumns='repeat(3, 1fr)' gap='37px'>
                        <Box w='349px' h='369px' bg='utility.white' overflow='hidden' border='1px' borderColor='gray.300' borderRadius='8px'>
                            <Image src={require('../asset/image/serviceImage.js/ทำความสะอาดทั่วไป.png')} alt='ทำความสะอาดทั่วไป' h='200px' w='100%' />
                        ...
                        <Box w='349px' h='369px' bg='utility.white' overflow='hidden' border='1px' borderColor='gray.300' borderRadius='8px'>
                            <Image src={require('../asset/image/serviceImage.js/ล้างแอร์.png')} alt={null} h='200px' w='100%' />
                            <Badge borderRadius='10%' px='10px' py='4px' bg='blue.100' mx='24px' mt='16px' mb='8px'>
                                <Text textStyle='b4' color='blue.800'>บริการทั่วไป</Text>
                            </Badge>
                        ...
                        <Box w='349px' h='369px' bg='utility.white' overflow='hidden' border='1px' borderColor='gray.300' borderRadius='8px'>
                            <Image src={require('../asset/image/serviceImage.js/ซ่อมเครื่องซักผ้า.png')} alt={null} h='200px' w='100%' />
                            <Badge borderRadius='10%' px='10px' py='4px' bg='blue.100' mx='24px' mt='16px' mb='8px'>
                                <Text textStyle='b4' color='blue.800'>บริการทั่วไป</Text>
                            </Badge>
            ...
            <Flex>
                <Center w='1440px' mb='42px'>
                    <Button role='click' bg='blue.600' textStyle='h5' color='utility.white' px='24px' py='10px' mt='70px' mb='175px' _hover={{ bg: 'blue.5 00' }}>ดูบริการทั้งหมด</Button>
                </Center>
            </Flex>
        </Container >
    )
